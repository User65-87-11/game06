...
void array_append(Array arr [static 1], const char s[static 1],size_t len);
 
void array_insert(Array arr [static 1], const char s[static 1],size_t len,size_t pos);
...
Array array_create(size_t size){
	...
	arr.data = calloc(size,sizeof(char));
	if(arr.data)
	{
		arr.capacity = size;
	}
